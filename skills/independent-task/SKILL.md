...
- **QCAA assessment conditions** (Year 8): short response 50–200 words/item; extended analytical response 400–600 words; exam up to 70 min + 10 min planning. (reaserch.md — see `references/analytical/year-8/task-specs.md`)

## Method

1. Pick the task type from `references/analytical/year-8/task-specs.md` matching `text_type` + `mode`.
...
- Conditions match `references/analytical/year-8/task-specs.md` for the year level + mode.
